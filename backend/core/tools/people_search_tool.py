...
class PeopleSearchTool(Tool):
    ...
    @openapi_schema({
        ...
        "function": {
            "name": "people_search",
            "description": "Search for people using natural language queries and enrich with LinkedIn profiles. IMPORTANT: Requires Exa Pro plan and costs $0.15 per search (10 results).",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
